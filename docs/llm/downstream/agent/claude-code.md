---
title: claude-code从零开始搭建
icon: lucide/brain-cog
---

本文档介绍了从零开始学习构建claude-code的完整过程
通过 v1 到 v8 的八次迭代，逐步构建一个完整的 Claude Code 架构复现。每个版本解决一个明确的架构问题，层层递进。

完整的代码以及文档地址：https://github.com/SakanaYdy/ydy_code
